...
import geatpy as ea
# 超参数，1.dropout 2.window_size 3.shift_size 4.learning_rate 5.weight_decay
# parameter
batch_size = 100
num_classes = 2
...
train_data = Generator.flow_from_directory(train_root, (224, 224), batch_size=batch_size,
                                           classes=['WithMask', 'WithoutMask'])
test_data = Generator.flow_from_directory(test_root, (224, 224), batch_size=batch_size,
                                          classes=['WithMask', 'WithoutMask'])
m = train_data.next()
